...
const EDITOR_SHORTCUTS: ShortcutEntry[] = [
    ...
    {key: 'Del / Backspace', name: 'Delete', description: 'Deletes the current selection.'},
    {
        key: 'P',
        name: 'Place',
        description: 'Adds a place at the position of the next mouse click within the editor. Press ctrl while clicking to add multiple places.'
    },
    {
        key: 'T',
        name: 'Transition',
        description: 'Adds a transition at the position of the next mouse click within the editor. Press ctrl while clicking to add multiple transitions.'
    },
    {
        key: 'A',
        name: 'Arc',
    ...
    {key: 'C', name: 'Color', description: 'Toggles the color palette.'},
    {
        key: '+',
        name: 'Increase',
        description: 'Increases the value of selected elements by 1. Use ctrl to increase in steps of 5.'
    },
    {
        key: '-',
        name: 'Decrease',
        description: 'Decreases the value of selected elements by 1. Use ctrl to decrease in steps of 5.'
    },
...
/**
 * The tooltip window for the editor, a dialog that displays a description and shortcuts for the editor.
 */
@Component({
